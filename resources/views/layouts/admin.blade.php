                    ...
                    <nav class="space-y-2">
                        ...
                        <a href="{{ route('admin.statistik') }}" 
                            class="flex items-center px-3 py-2 text-sm font-medium text-gray-700 rounded-lg 
                                {{ request()->routeIs('admin.statistik') ? 'bg-indigo-50 text-indigo-700' : 'hover:bg-indigo-50 hover:text-indigo-700' }} 
                        ...
                        <a href="{{ route('admin.keluarga.index') }}" 
                            class="flex items-center px-3 py-2 text-sm font-medium text-gray-700 rounded-lg 
                                {{ request()->routeIs('admin.keluarga.index') ? 'bg-indigo-50 text-indigo-700' : 'hover:bg-indigo-50 hover:text-indigo-700' }} 
                                transition-colors duration-200">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('diskusi.index') }}" 
                            class="flex items-center px-3 py-2 text-sm font-medium text-gray-700 rounded-lg 
                                {{ request()->routeIs('diskusi.index') ? 'bg-indigo-50 text-indigo-700' : 'hover:bg-indigo-50 hover:text-indigo-700' }} 
                                transition-colors duration-200">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
